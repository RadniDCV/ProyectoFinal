...
} from "./chunk-XIVUPTNM.js";
import {
  _extends
} from "./chunk-7CYDX2RJ.js";
import {
  require_prop_types
} from "./chunk-OHDWSV5M.js";
import "./chunk-47XRP2OC.js";
import {
  require_react_dom
} from "./chunk-XZ7MSK3I.js";
import "./chunk-ZDJTD4GJ.js";
import {
  require_react
...
function delay(callback, timeout) {
  ...
  es_default2.read(checkElapsed, true);
...
function keyframes3({ from = 0, to = 1, ease, offset, duration = 300 }) {
...
var types = { decay, keyframes: keyframes3, spring };
...
function convertTransitionToAnimationOptions({ ease, times, yoyo, flip, loop, ...transition2 }) {
...
var VisualElement = class {
  constructor({ parent, props, reducedMotionConfig, visualState }, options = {}) {
    ...
    this.scheduleRender = () => es_default2.render(this.render, false, true);
  ...
  bindToMotionValue(key, value) {
    ...
    const removeOnChange = value.onChange((latestValue) => {
      ...
      this.props.onUpdate && es_default2.update(this.notifyUpdate, false, true);
...
function useForceUpdate() {
  ...
  const deferredForceRender = (0, import_react35.useCallback)(() => es_default2.postRender(forceRender), [forceRender]);
...
function useCounter(props = {}) {
  ...
  const reset = (0, import_react99.useCallback)(() => {
    ...
    if (defaultValue == null) {
      ...
      next = (_a = cast2(defaultValue, stepProp, precisionProp)) != null ? _a : min;
    }
    update(next);
  }, [defaultValue, precisionProp, stepProp, update, min]);
  const castValue = (0, import_react99.useCallback)((value2) => {
    var _a;
    const nextValue = (_a = cast2(value2, stepProp, precision)) != null ? _a : min;
    update(nextValue);
...
function useUnmountEffect2(fn, deps = []) {
  return (0, import_react120.useEffect)(() => () => fn(), deps);
}
...
var win = {
  ...
  addEventListener: noop4,
  removeEventListener: noop4,
  getComputedStyle() {
    return {
      getPropertyValue() {
        return "";
...
function usePopper(props = {}) {
  ...
  const reference = (0, import_react145.useRef)(null);
  const popper = (0, import_react145.useRef)(null);
...
function isTargetMenuItem(target) {
  var _a;
  return isHTMLElement2(target) && !!((_a = target == null ? void 0 : target.getAttribute("role")) == null ? void 0 : _a.startsWith("menuitem"));
}
...
function useMenuItem(props = {}, externalRef = null) {
  ...
  const onFocus3 = (0, import_react151.useCallback)((event) => {
...
function useUnmountEffect3(fn, deps = []) {
  return (0, import_react151.useEffect)(() => () => fn(), deps);
}
...
function useNumberInput(props = {}) {
  ...
  const format = (0, import_react174.useCallback)((value) => {
    var _a;
